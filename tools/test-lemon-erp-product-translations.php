...
// The plugin must not advertise term-link readiness before the bootstrap.
...
test_expect($capabilities->data['plugin_version'] === '0.5.5', 'The capability endpoint returned an unexpected plugin version.');
...
test_expect($linkedVariations->data['plugin_version'] === '0.5.5', 'The variation response returned an unexpected plugin version.');
