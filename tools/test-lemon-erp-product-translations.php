...
test_expect($capabilities->data['plugin_version'] === '0.5.9', 'The capability endpoint returned an unexpected plugin version.');
...
test_expect($linkedVariations->data['plugin_version'] === '0.5.9', 'The variation response returned an unexpected plugin version.');
