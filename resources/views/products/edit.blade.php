            ...
            <div class="product-edit-body">
                ...
                <div class="product-form-grid">
                    ...
                    <label>Atrybut wariantu
                        <input name="variant_attribute" value="{{ $masterField('variant_attribute', 'variant_attribute') }}" placeholder="np. Rozmiar">
                    </label>
                    <label>Opracowane
                        <input type="hidden" name="developed" value="0">
                        <span class="toggle-row"><input name="developed" type="checkbox" value="1" @checked(old('developed', (bool) data_get($master, 'developed'))) > Tak</span>
                    </label>
                </div>
            </div>
        </section>
