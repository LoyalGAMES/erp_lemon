            ...
            <div class="product-quick-edit-body">
                ...
                <div class="product-quick-form-grid">
                    ...
                    <label>Atrybut wariantu
                        <input name="variant_attribute" value="{{ $quickMasterField('variant_attribute', 'variant_attribute') }}" placeholder="np. Rozmiar">
                    </label>
                    <label>Opracowane
                        <input type="hidden" name="developed" value="0">
                        <span class="product-quick-toggle-row"><input name="developed" type="checkbox" value="1" @checked(old('developed', (bool) data_get($quickMaster, 'developed'))) > Tak</span>
                    </label>
                </div>
            </div>
        </section>
