...
class PackingWorkflowTest extends TestCase
{
    ...
    public function test_processing_order_creates_packing_task_and_scanner_marks_it_picked(): void
    {
        ...
        $this->get(route('packing.index', ['view' => 'pack']))
            ...
            ->assertSee('shipment-primary-actions', false)
            ->assertSee('packing-skip-label-form', false)
            ->assertSeeInOrder(['gabaryt C', 'Pomiń list i spakuj'], false)
            ->assertDontSee('Bez listu przewozowego')
            ->assertDontSee('Przejdź dalej bez numeru i bez śledzenia przesyłki.')
            ->assertSee('packing-customer-note', false)
