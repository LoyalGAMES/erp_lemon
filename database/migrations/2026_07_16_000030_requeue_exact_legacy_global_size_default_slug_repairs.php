...
return new class extends Migration
{
                ...
                foreach ($mappings as $mapping) {
                    DB::transaction(function () use ($mapping): void {
                        ...
                        if ($this->shouldRequeue($state, $channel)) {
                            ...
                            // Keep every 000029 gate row visible under the new
                            // revision; only the exact known failure is retried.
    ...
    {
        // Deliberate no-op: a completed remote repair must not be reversed.
    }
