                ...
                foreach ($mappings as $mapping) {
                    DB::transaction(function () use ($mapping): void {
                        ...
                        if ($this->shouldRequeue($state, $channel)) {
                            ...
                            // Keep the complete 000027 deployment-gate
                            // population visible. Only the exact production
                            // failure above is changed back to pending.
                        ...
                        // Update metadata directly so legacy raw external IDs
                        // never pass through model normalization as collateral
                        // damage of this queue-only migration.
