...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Revision 000047 completed every ordinary family and isolated one
        // exact exception: a reciprocal EN parent exists as a simple product
        // without children. Requeue that unresolved family so the repair can
        // hand it to the canonical full exporter for variable reconstruction.
        ProductChannelMapping::query()
            ...
            ->where(
                ...
                WooOwnedVariantAxisRepairService::PREVIOUS_SIMPLE_TRANSLATION_REBUILD_REVISION,
            )
