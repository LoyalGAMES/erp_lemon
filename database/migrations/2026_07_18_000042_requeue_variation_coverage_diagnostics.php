...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Retry only the unresolved 000041 families. The repair remains
        // fail-closed, but now records the exact child-size multiplicities so
        // the production shape can be resolved without guessing or merging
        // stock-bearing variations.
        ProductChannelMapping::query()
            ...
            ->where(
                ...
                WooOwnedVariantAxisRepairService::PREVIOUS_VARIATION_COVERAGE_DIAGNOSTIC_REVISION,
            )
