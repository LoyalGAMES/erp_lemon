...
return new class extends Migration
{
    public function up(): void
    {
        ...
        $wooChannelIds = WordpressIntegration::query()
            ->with('salesChannel')
            ->get()
        ...
        // Only persist a durable local request here. The scheduled backfill
        // dispatcher performs the remote export after the deployment has
        // completed and the updated exporter is available to queue workers.
        ProductChannelMapping::query()
            ->whereIn('sales_channel_id', $wooChannelIds)
    ...
    {
        // Deliberate no-op. A queued or completed remote correction must not
        // be reverted when application code is rolled back.
    }
