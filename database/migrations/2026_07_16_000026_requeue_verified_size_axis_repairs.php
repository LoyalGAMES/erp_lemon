...
return new class extends Migration
{
    public function up(): void
    {
        ...
        ProductChannelMapping::query()
            ...
            ->where(
                ...
                WooOwnedVariantAxisRepairService::PREVIOUS_COMPLEMENTARY_LANGUAGE_REVISION,
            )
            ->whereIn(
                'metadata->maintenance->woo_owned_variant_axis_repair->status',
                ['pending', 'queued', 'failed', 'manual_review'],
            )
            ->with('product')
            ->orderBy('id')
    ...
    public function down(): void
    {
        ...
        // must never be rolled back to the damaged legacy variation axis.
    }
};
