...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Revision 62 proved that production Woo omits the Polylang
        // `translations` field even though the target term is already linked.
        // Retry only this exact conflict with the non-mutating family probe.
    ...
    {
        // Deliberate no-op. The remote translation family is not mutated by
        // this migration and must remain authoritative during rollback.
    }
};
