...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Revision 000043 repaired the first exact numeric families and
        // exposed two remaining historical identities: Polylang-qualified
        // Size slugs and synthetic families whose durable child mapping IDs,
        // rather than stale SKUs, form the exact primary bijection.
        ProductChannelMapping::query()
            ...
            ->where(
                ...
                WooOwnedVariantAxisRepairService::PREVIOUS_LANGUAGE_SUFFIX_AND_MAPPING_ID_REVISION,
            )
