...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Revision 000039 proved 24 production families and isolated the last
        // two safe historical shapes: stale parent axes whose values differ
        // from the axes actually assigned to children, and a synthetic
        // WC-B2C-PARENT-{Woo ID} SKU under the complete Lemon contract. Retry
        // only unresolved families from that exact audit.
        ProductChannelMapping::query()
            ...
            ->where(
                ...
                WooOwnedVariantAxisRepairService::PREVIOUS_ACTIVE_CHILD_AXIS_REVISION,
            )
