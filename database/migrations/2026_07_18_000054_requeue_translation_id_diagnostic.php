...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Re-run only the unresolved canonical translation hand-off. Revision
        // 000054 adds resource- and ID-specific validation so the final legacy
        // Polylang collision can be repaired without guessing or broad writes.
        ProductChannelMapping::query()
            ...
            ->where(
                ...
                WooOwnedVariantAxisRepairService::PREVIOUS_TRANSLATION_ID_DIAGNOSTIC_REVISION,
            )
    ...
    {
        // Deliberate no-op. Remote identities may have been allocated by the
        // retried hand-off and must remain resumable after code rollback.
    }
};
