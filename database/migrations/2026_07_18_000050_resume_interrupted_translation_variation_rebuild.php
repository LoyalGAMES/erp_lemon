...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // The EN parent was converted to variable and its canonical Size axis
        // was saved, but the following deployment interrupted the exporter
        // before translated children existed. Resume only that unresolved,
        // explicitly marked hand-off; ordinary empty variable families remain
        ...
        ProductChannelMapping::query()
            ...
            ->where(
                ...
                WooOwnedVariantAxisRepairService::PREVIOUS_INTERRUPTED_TRANSLATION_VARIATION_REBUILD_REVISION,
            )
