...
return new class extends Migration
{
    public function up(): void
    {
        ...
        // Revision 000044 exposed Woo's response normalization during the EN
        // transition: the saved term identity `40-en` can be returned as
        // `40`. Retry only unresolved 000044 families and confirm target axes
        // through their exact ERP Size identity.
        ProductChannelMapping::query()
            ...
            ->where(
                ...
                WooOwnedVariantAxisRepairService::PREVIOUS_TRANSITION_CONFIRMATION_REVISION,
            )
