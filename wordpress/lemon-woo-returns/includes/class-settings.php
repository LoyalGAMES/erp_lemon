...
class LL_Returns_Settings {
	...
	public static function get_default_form_texts() {
		return array(
			...
			'back_button'                 => 'Wróć',
			'next_button'                 => 'Dalej',
			'payment_title'               => 'Sposób zwrotu pieniędzy',
			'cashback_title'              => 'Cashback',
			'cashback_description'        => 'Środki wrócą automatycznie przez operatora płatności.',
			'bank_transfer_title'         => 'Przelew na konto',
			'bank_transfer_description'   => 'Dla zamówienia pobraniowego zwrócimy środki na wskazany rachunek.',
			'bank_account_label'          => 'Numer rachunku do zwrotu',
			'bank_recipient_label'        => 'Imię i nazwisko właściciela rachunku',
	...
	public static function get_form_text_field_labels() {
		return array(
			...
			'step_payment'               => __( 'Krok: zwrot środków', 'lemon-woo-returns' ),
			...
			'payment_title'              => __( 'Nagłówek kroku płatności', 'lemon-woo-returns' ),
			'cashback_title'             => __( 'Opcja: cashback', 'lemon-woo-returns' ),
			'cashback_description'       => __( 'Opis cashbacku', 'lemon-woo-returns' ),
			'bank_transfer_title'        => __( 'Opcja: przelew na konto', 'lemon-woo-returns' ),
			'bank_transfer_description'  => __( 'Opis przelewu na konto', 'lemon-woo-returns' ),
			'bank_account_label'         => __( 'Pole: numer rachunku', 'lemon-woo-returns' ),
			'bank_recipient_label'       => __( 'Pole: właściciel rachunku', 'lemon-woo-returns' ),
